      ...
      messages: [
        {
          role: "system",
          content: systemPromptWithLang(
            'Verdict must be exactly "strong_yes", "maybe", or "no". JSON only. Be specific to THIS candidate\'s CV. Reference actual experiences, projects, certifications mentioned in the CV. Never give generic advice that could apply to anyone. Do not repeat information from other sections.',
            langNorm
          ),
        },
        { role: "user", content: user },
