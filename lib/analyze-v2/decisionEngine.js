...
Return ONLY valid JSON:
{
  ...
  "recognition_line": "<one short sentence that mirrors the candidate's likely behavior, inferred from signals and tied to evidence>",
  ...
  "pattern_summary": "<cross-issue narrative pattern inferred from multiple issues>",
  "reasons": [
