...
- priority: use "high" for exactly ONE fix — the single primary next action the user should do first (this drives "Do this next" in the UI). Use "medium" or "low" for the other fixes. If a fix is not actionable short-term, still give a pivot or skill-shift step (never leave the high-priority fix without steps).
...
- Do not add any keys other than issue, severity, priority, steps, resource inside each fixes[] item
