...
export async function runGapEngine(cvText, jobDescription, sector) {
...
Use at least 3 rejection_reasons when problems exist; if genuinely strong fit, still list 1-2 risks.`;
  ...
  return {
    rejection_reasons,
    biggest_gap: String(p.biggest_gap || "").trim() || "Unable to isolate a single gap.",
  };
}
