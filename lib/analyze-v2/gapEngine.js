    ...
    messages: [
      {
        ...
        content: systemPromptWithLang(
          "You explain why hiring managers would screen out the applicant for this job — concrete, harsh, filter-level reasons only. JSON only. No therapist tone. In issue and explanation, address the applicant as \"you\" (never \"the candidate\"). Be specific to their CV. Reference actual experiences, projects, certifications they listed. Never give generic advice that could apply to anyone. Do not repeat information from other sections.",
          langNorm
        ),
      },
