...
Simulate ATS parsing and keyword screening for THIS sector lens.
Output structured JSON fields only. No natural-language explanations.
...
Return ONLY valid JSON:
{
  ...
  const system = systemPromptWithLang(
    "You are an ATS parser simulator. Focus ONLY on structured extraction and scoring evidence. Return valid JSON only. No narrative explanation text.",
    langNorm
  );
 ...
 * When only soft gaps remain, avoid over-penalizing "preferred" like "must-have".
 */
