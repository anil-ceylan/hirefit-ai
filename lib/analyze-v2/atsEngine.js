...
export async function runAtsEngine(cvText, jobDescription, sector, langNorm = "en") {
  ...
  const langInstruction = langNorm === "tr"
    ? "SEN TURKCE KONUSAN BIR UZMANSIN. BUTUN CIKTILARIN TURKCE OLMALI. INGILIZCE YAZMA. CV veya is ilani Ingilizce olsa bile tum skill/anahtar kelime listelerini Turkce yaz (terimler dilbilgisi olarak Ingilizce kalabilir: SQL, AWS)."
  ...
  const skillListRule =
    langNorm === "tr"
      ? "missing_keywords ve top_keywords: YALNIZCA teknik beceriler, yazılımlar, metodolojiler, çerçeveler, mesleki sertifikalar. Şirket politikaları, HR/yan haklar, eğitim şartları (fakülte, diploma, zorunlu staj), sigorta, vize/çalışma izni, ücret — bunlar KESİNLİKLE skill değildir ve listelenmez."
      : "missing_keywords and top_keywords: ONLY technical skills, software, methodologies, frameworks, and professional certifications. NEVER list company policies, benefits, education requirements, mandatory internship conditions, insurance, visas, or generic employment terms as skills.";
...
Turkish mode rule: Açıklamaları Türkçe yaz; teknik ürün/kısaltma adları (SQL, AWS, Jira) İngilizce kalabilir.
