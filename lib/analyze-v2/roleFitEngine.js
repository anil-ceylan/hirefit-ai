    ...
    messages: [
      {
        ...
        content: systemPromptWithLang(
          "You map CV evidence to role families. No encouragement. JSON only. Evidence lines must address the applicant as \"you\". Be specific to their CV. Reference actual experiences, projects, certifications they listed. Never give generic advice that could apply to anyone. Do not repeat information from other sections.",
          langNorm
        ),
      },
