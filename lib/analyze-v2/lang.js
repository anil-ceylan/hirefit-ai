...
export function fallbackNoReasoning(langNorm) {
  return langNorm === "tr"
    ? "Profili tamamen dışarıda görmüyorum; ama bu ilan için rol örnekleri yeterince net değil, kararda temkinliyim."
    : "I would not call you totally misaligned, but role-specific proof is not explicit enough yet—I stay cautious.";
}
