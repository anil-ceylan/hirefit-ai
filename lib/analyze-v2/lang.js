...
export function requiredResponseLanguageDirective(langNorm) {
  ...
  return `Respond entirely in ${language}. All analysis text, gap descriptions, action items, recruiter views, and recommendations must be in ${language}. Do not mix languages.`;
}
