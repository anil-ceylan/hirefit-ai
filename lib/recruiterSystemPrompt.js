/* eslint-env node */
import { requiredResponseLanguageDirective } from "./analyze-v2/lang.js";
/**
...
export function buildRecruiterSystemPrompt(langNorm, opts = {}) {
  ...
  const directive = requiredResponseLanguageDirective(langNorm);
  const base = includeLead ? `${FIRST_PERSON_RULE}\n\n${body}` : body;
  return `${directive}\n\n${base}`;
}
