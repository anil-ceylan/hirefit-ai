...
export const CAREER_PROFILE_COMPLETION_CONFIG = [
  ...
  { id: "education", weight: 12, labelTr: "Education", labelEn: "Education", checkKey: "education", listGroup: "core" },
  { id: "experience", weight: 10, labelTr: "Experience", labelEn: "Experience", checkKey: "experience", listGroup: "core" },
  { id: "career_goals", weight: 12, labelTr: "Career Goals", labelEn: "Career Goals", checkKey: "careerGoals", listGroup: "core" },
  { id: "leadership", weight: 8, labelTr: "Leadership", labelEn: "Leadership", checkKey: "leadership", listGroup: "core" },
  { id: "english", weight: 6, labelTr: "İngilizce", labelEn: "English", checkKey: "english", listGroup: "core" },
  { id: "network", weight: 6, labelTr: "Network", labelEn: "Network", checkKey: "network", listGroup: "core" },
  ...
  { id: "portfolio", weight: 6, labelTr: "Portfolio", labelEn: "Portfolio", checkKey: "portfolio", listGroup: "evidence" },
  { id: "case_study", weight: 5, labelTr: "Case Study", labelEn: "Case Study", checkKey: "caseStudy", listGroup: "evidence" },
  { id: "certifications", weight: 5, labelTr: "Certifications", labelEn: "Certifications", checkKey: "certifications", listGroup: "evidence" },
  { id: "english_proof", weight: 5, labelTr: "English Proof", labelEn: "English Proof", checkKey: "englishProof", listGroup: "evidence" },
