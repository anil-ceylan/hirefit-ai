...
export const listCareerCompanionCases = (getHeaders) => requestCareerCompanion("/api/career-companion/cases", getHeaders);
...
export const generateCareerCompanionGuidance = (getHeaders, id, lang) => requestCareerCompanion(`/api/career-companion/cases/${encodeURIComponent(id)}/guidance`, getHeaders, { method: "POST", body: JSON.stringify({ lang }) });
